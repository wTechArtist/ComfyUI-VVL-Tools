...
# 合并所有节点映射
NODE_CLASS_MAPPINGS = {**JSON_MAPPINGS, **BLOCKER_MAPPINGS, **BATCH_MAPPINGS, **RENDERER_MAPPINGS}
NODE_DISPLAY_NAME_MAPPINGS = {**JSON_DISPLAY_MAPPINGS, **BLOCKER_DISPLAY_MAPPINGS, **BATCH_DISPLAY_MAPPINGS, **RENDERER_DISPLAY_MAPPINGS}
